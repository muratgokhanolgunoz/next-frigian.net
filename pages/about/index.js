...
import About from "../../src/components/frontend/pages/about/Index";
        ...
        <>
            <Layout>
                <Head>
                    ...
                    <title>{t("navbar.NAVBAR_ITEM_ABOUT")} - {t("template.HTML_PAGE_TITLE")}</title>
                    <meta
                        name="keywords"
                    ...
                    <meta
                        property="og:title"
                        content={t("navbar.NAVBAR_ITEM_ABOUT") + " - " + t("template.HTML_PAGE_TITLE")}
                    />
                    <meta
                        property="og:url"
