...
const CompanyForm = () => {
    ...
    const getCountryInfo = () => {
        registerServices
            .getCountryInfo()
            .then((response) => {
                pricingContext.setCountryId(response.data.countryId);
                pricingContext.setCountryName(response.data.countryName);
            })
    ...
    const formValidation = () => {
        if (
            pricingContext.state.countryId === "" ||
            pricingContext.state.countryName === "" ||
